...
public interface ProductsApi {
    ...
    ResponseEntity<Product> createProduct(@Parameter(in = ParameterIn.DEFAULT, description = "", schema=@Schema()) @Valid @RequestBody Product body
);


    @Operation(summary = "Delete All Products", description = "Delete All Products", tags={ "Products" })
    @ApiResponses(value = { 
